...
Mausi should not need to request documentation updates after every change. Before completing any material project task, update every affected living document.
...
- Preserve complete prompts in `prompt-history.md` or a linked file under `docs/archive/prompts/`.
...
- Update `BUILD_LOG.md` chronologically with decisions, unexpected results, tests, lessons, and commits.
- Update the README and project plan when public status or remaining work changes.
- Update requirement and audit documents when Mausi changes a requirement.
...
Mausi is the final decision-maker for project scope, design acceptance, requirement changes, AI-output approval, and submission content.
